...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/forms/styling/uniform.min.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/plugins/pickers/daterangepicker.js"></script>

	<script type="text/javascript" src="${ctxStatic }/assets/js/core/app.js"></script>
	<script type="text/javascript" src="${ctxStatic }/assets/js/pages/dashboard.js"></script>
	<!-- /theme JS files -->
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html"><img src="${ctxStatic }/assets/images/logo_light.png" alt=""></a>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="${ctxStatic }/assets/images/flags/gb.png" class="position-left" alt="">
						English
						<span class="caret"></span>
					</a>

					<ul class="dropdown-menu">
						<li><a class="deutsch"><img src="${ctxStatic }/assets/images/flags/de.png" alt=""> Deutsch</a></li>
						<li><a class="ukrainian"><img src="${ctxStatic }/assets/images/flags/ua.png" alt=""> Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°</a></li>
						<li><a class="english"><img src="${ctxStatic }/assets/images/flags/gb.png" alt=""> English</a></li>
						<li><a class="espana"><img src="${ctxStatic }/assets/images/flags/es.png" alt=""> EspaÃ±a</a></li>
						<li><a class="russian"><img src="${ctxStatic }/assets/images/flags/ru.png" alt=""> Ð ÑÑÑÐºÐ¸Ð¹</a></li>
					</ul>
				</li>
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content width-350">
						...
						<ul class="media-list dropdown-content-body">
							<li class="media">
								<div class="media-left">
									<img src="${ctxStatic }/assets/images/placeholder.jpg" class="img-circle img-sm" alt="">
							...
							<li class="media">
								<div class="media-left"><img src="${ctxStatic }/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="${ctxStatic }/assets/images/placeholder.jpg" alt="">
						<span>Victoria</span>
						<i class="caret"></i>
					</a>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								<a href="#" class="media-left"><img src="${ctxStatic }/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></a>
								<div class="media-body">
											...
											<tr>
												<td>
													<div class="media-left media-middle">
														<a href="#"><img src="${ctxStatic }/assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
													</div>
													<div class="media-left">
											...
											<ul class="media-list content-group">
												<li class="media stack-media-on-mobile">
				                					<div class="media-left">
														<div class="thumb">
															<a href="#">
																<img src="${ctxStatic }/assets/images/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
								...
								<div class="tab-content">
									<div class="tab-pane active fade in has-padding" id="messages-tue">
										<ul class="media-list">
											<li class="media">
												<div class="media-left">
													<img src="${ctxStatic }/assets/images/placeholder.jpg" class="img-circle img-xs" alt="">
